...
<head>
    ...
    <title>SCMS - Manage Customers</title>
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables">
                                ...
                                <tbody>
                                    ...
                                    $userData = $db->query("SELECT customer_id, customer_name, customer_address, customer_phone, customer_email FROM customers_list");

                                    while ($row = mysqli_fetch_array($userData, MYSQLI_ASSOC)) {

                                        echo '<tr>
                                                    <td><a style="text-decoration:none; color:red;">'.$row['customer_name'].'</a></td>
                                                    <td>'.$row['customer_address'].'</td>
                                                    <td>'.$row['customer_phone'].'</td>
                                                    <td>'.$row['customer_email'].'</td>
                                                    <td class="text-center">
                                                        <a href="edit_customer.php?customer_id='.$row['customer_id'].'" class="btn btn-default btn-sm">
                                                            <span class="glyphicon glyphicon-edit text-success"></span> Edit 
                                                        </a>
                                                        <a href="#" id="'.$row['customer_id'].'" class="delete_customer btn btn-default btn-sm">
