...
<head>
    ...
    <title>SCMS - Manage Tax or Discount</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Manage Tax Fee / Discount</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables">
                                        ...
                                        <tbody>
                                            <?php
                                            $taxData = $db->query("SELECT tax_id, tax_name, tax_amount FROM tax_list");
                                            while ($row = mysqli_fetch_array($taxData, MYSQLI_ASSOC)) {
                                            echo
                                                '<tr>
                                                    <td><a style="text-decoration:none; color:red;">'.$row['tax_name'].'</a></td>
                                                    <td>'.$row['tax_amount'].'</td>
                                                    <td class="text-center">
                                                        <a href="edit_tax.php?tax_id='.$row['tax_id'].'" class="btn btn-default btn-sm demouser">
                                                            <span class="glyphicon glyphicon-edit text-success"></span> Edit 
                                                        </a>
                                                        <a href="#" id="'.$row['tax_id'].'" class="btn btn-default btn-sm delete_tax">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables2">
                                        ...
                                        <tbody>
                                            <?php
                                            $discountData = $db->query("SELECT discount_id, discount_name, discount_amount FROM discount_list");
                                            while ($row2 = mysqli_fetch_array($discountData, MYSQLI_ASSOC)) {
                                            echo
                                                '<tr>
                                                    <td><a style="text-decoration:none; color:red;">'.$row2['discount_name'].'</a></td>
                                                    <td>'.$row2['discount_amount'].'</td>
                                                    <td class="text-center">
                                                        <a href="edit_discount.php?discount_id='.$row2['discount_id'].'" class="btn btn-default btn-sm">
                                                            <span class="glyphicon glyphicon-edit text-success"></span> Edit 
                                                        </a>
                                                        <a href="#" id="'.$row2['discount_id'].'" class="delete_discount btn btn-default btn-sm">
                                                            <span class="glyphicon glyphicon-remove text-danger"></span> Remove 
                                                        </a>
                                                    </td>   
                                                </tr>';
    ...
    <!-- jAlert -->
    <script src="../vendor/jAlert-master/dist/jAlert.min.js"></script>
    ...
    table2.buttons().container()
        .appendTo( '#dataTables2_wrapper .col-sm-6:eq(0)' );
    } );
